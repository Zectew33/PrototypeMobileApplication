...
public class Clockout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditText = findViewById(R.id.noteOut);
        ...
        switch (biometricManager.canAuthenticate()) { //Different possibilities
            case BiometricManager.BIOMETRIC_SUCCESS: //We can use biometric sensor
                msg_txt.setText("You can use the fingerprint sensor to clock out!");
        ...
        BiometricPrompt biometricPrompt = new BiometricPrompt(Clockout.this, executor, new BiometricPrompt.AuthenticationCallback() {
            ...
            public void onAuthenticationSucceeded(@NonNull @org.jetbrains.annotations.NotNull BiometricPrompt.AuthenticationResult result) {
                ...
                Toast.makeText(getApplicationContext(), "Clock out successfully!", Toast.LENGTH_SHORT).show();
            }
        ...
        BiometricPrompt.PromptInfo promptInfo = new BiometricPrompt.PromptInfo.Builder()
                .setTitle("Clock out")
                .setDescription("Use your fingerprint to clock out!")
    ...
    public void openNewActivity() {
        Intent intent = new Intent(this, NurseLogout.class);
        intent.putExtra("noteOut", mEditText.getText().toString().trim());
